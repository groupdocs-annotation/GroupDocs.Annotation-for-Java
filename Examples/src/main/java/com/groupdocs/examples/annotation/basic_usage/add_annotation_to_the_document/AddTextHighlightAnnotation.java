...
public class AddTextHighlightAnnotation {
    ...
    public static Path run(Path inputFile) {
        final Path outputPath = FilesUtils.makeOutputPath("AddTextHighlightAnnotation" + obtainExtension(inputFile));
        ...
        try (final Annotator annotator = new Annotator(inputFile.toString())) {
            ...
            highlightAnnotation.setBackgroundColor(65535);
            highlightAnnotation.setCreatedOn(Calendar.getInstance().getTime());
            highlightAnnotation.setFontColor(0);
            highlightAnnotation.setMessage("This is highlight annotation");
            highlightAnnotation.setOpacity(0.5);
            highlightAnnotation.setPageNumber(0);
            highlightAnnotation.setPoints(points);
            highlightAnnotation.setReplies(replies);
